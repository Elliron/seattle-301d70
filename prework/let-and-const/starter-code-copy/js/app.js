...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT When the variable "rando" used var is was global and the let turned it local.  The call was outside of the function that the "rando" lives in resulting in it breaking.
  console.log(viewed);
