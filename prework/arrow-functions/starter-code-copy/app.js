...
// "this" is the object created by the Student constructor
// 2. What is "this" when joe.scopeArrow() is invoked?
// Arrow notation does not work with prototypes and constructor so joe.scopeArrow() is returning the window object
// 3. Explain why "this" is different when an arrow function is used.
//  "this" is unbindable in Arrow notation, it uses the "this" from the code that contains the arrow function.